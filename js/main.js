$.getScript('http://182.92.107.44/osports/osports-1506-change/js/license.js?_=' + new Date().getTime(), function(data, textStatus, jqxhr) {
  if (canUse == true) {
    ...
    console.log('授权已失效，请联系 nbagonet@gmail.com ，谢谢。');
  }
});